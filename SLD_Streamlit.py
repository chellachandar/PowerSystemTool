    ...
    with st.spinner(f"Drafting Standards-Compliant Diagram..."):
        ...
        # =========================================================================
            ...
            def middle_common_15(ax, x_offset, y_offset, feeder_num, fs, i):
                ...
                # Upper Isolator
                draw_isolator(ax, x_offset+.25, y_offset+0.4, L["base_isolator"], fs)
                # Upper Earth Switch
                earth_sh(ax, x_offset+.25, y_offset+0.2, L["earth_lbl1"], fs)
                ...
                # Lower Earth Switch
                earth_sh(ax, x_offset+0.25, y_offset-4.0, L["earth_lbl2"], fs)
                # Lower Isolator
                draw_isolator(ax, x_offset+0.25, y_offset-5.0, L["base_isolatorb"], fs)
                
                # Continuous connecting wire
                ax.plot([x_offset+0.25, x_offset+0.25], [y_offset-0.3, y_offset-5.0], color='red', linewidth=0.5)
